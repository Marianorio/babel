...
const ERROR_MESSAGES: Record<string, string> = {
  AccessDenied: "Acceso denegado. No tienes permiso para iniciar sesión con esa cuenta.",
  Configuration: "Error de configuración del servidor. Intenta más tarde.",
  ...
  Callback: "Error en la autenticación. Intenta de nuevo.",
